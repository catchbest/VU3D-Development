...
KSJGIGEVISIONAPI_API int __stdcall KSJGIGEVISION_CameraGetIp(int nAdapterIndex, int nCameraIndex, char* szIP);
...
KSJGIGEVISIONAPI_API int __stdcall KSJGIGEVISION_CameraSetCameraSize(int nAdapterIndex, int nCameraIndex, int nWidth, int nHeight);
